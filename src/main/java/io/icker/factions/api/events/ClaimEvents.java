...
public final class ClaimEvents {
    ...
    public interface Modify {
        /** Called whenever a Claim’s data is changed programmatically */
        void onModify(Claim claim);
    }
    public static final Event<Modify> MODIFY =
            EventFactory.createArrayBacked(Modify.class, callbacks -> claim -> {
                for (Modify c : callbacks) c.onModify(claim);
            });
