...
public class ModifyGui extends SimpleGui {
    ...
    private GuiElementBuilder factionTypeButton(Faction faction) {
        return new GuiElementBuilder(Items.PLAYER_HEAD)
                ...
                .setCallback((slotIndex, clickType, actionType) -> {
                    ...
                    // re-render this slot with the updated state
                    this.setSlot(slotIndex, factionTypeButton(faction));
                });
    }
    ...
    public ModifyGui(ServerPlayerEntity player, Faction faction, @Nullable Runnable closeCallback) {
        ...
        this.setSlot(5, factionTypeButton(faction));
